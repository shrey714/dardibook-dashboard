...
const Medical = () => {
  ...
  if (isDesktop) {
    ...
    return (
      <main className="min-h-[calc(100svh-53px)] bg-background">
        <BillHistoryModal
          billModal={billModal}
          setbillModal={setbillModal}
          selectedBillData={selectedBillData}
          setselectedBillData={setselectedBillData}
        />
        <div className="w-full p-0 hidden sm:flex flex-row items-center absolute top-[35px] z-[2]">
          <span className="flex flex-1 h-[2px] bg-gradient-to-r from-transparent to-primary"></span>
          <div className=" flex items-center justify-center">
            <p className="text-primary w-auto px-3 bg-background py-1 font-medium text-base rounded-full border-primary border-[2px]">
              Pharmacy Space
        ...
        <div className="w-full flex flex-row bg-background sticky top-0 rounded-none p-1 border-b shadow-sm sm:p-2 z-[1]">
          <Drawer>
