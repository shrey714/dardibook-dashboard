...
export const DateTimePicker: React.FC<DateTimePickerProps> = ({
  ...
  // Check if the date is valid (not the default empty date)
  const isDateSelected = getTime(date) !== getTime(new Date(0));
      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          {isDateSelected ? (
            ...
            <span>MM/DD/YYYY hh:mm aa{required && " *"}</span>
          )}
        </Button>
      </PopoverTrigger>
      <PopoverContent className="w-auto p-0">
        <div className="sm:flex">
          <Calendar
            ...
            mode="single"
            selected={isDateSelected ? date : undefined}
