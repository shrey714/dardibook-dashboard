...
const MedicalReportPrint = forwardRef<HTMLDivElement, Props>((props, ref) => {
        ...
        <table className="w-full border-collapse border border-gray-400">
          <tbody>
            <tr>
              ...
              <td className="border border-gray-400 p-1 pl-2">
                {prescriptionInfo.medicines.reduce((total, medicine) => {
                  return (
                    total + (medicine.amount ? Number(medicine.amount) : 0)
                  );
                }, 0)}
              </td>
            </tr>
...
MedicalReportPrint.displayName = "Prescription";

export default MedicalReportPrint;
