"use client";
import { FileChartPieIcon, FileIcon,DockIcon, PresentationIcon } from "lucide-react";
...
export default function Next() {
  return (
    ...
    >
      ...
      >
        <Link
          href={`/onboarding?type=pitchdeck`}
        ...
        <Link
          href={`/onboarding?type=sales-document`}
          className="flex min-h-[200px] flex-col items-center justify-center space-y-5 overflow-hidden p-5 transition-colors hover:bg-gray-200 hover:dark:bg-gray-800 md:p-10"
        >
        ...
        <Link
          href={`/onboarding?type=notion`}
          className="flex min-h-[200px] flex-col items-center justify-center space-y-5 overflow-hidden p-5 transition-colors hover:bg-gray-200 hover:dark:bg-gray-800 md:p-10"
        >
          <DockIcon className="pointer-events-none h-auto w-12 sm:w-12" />
          <p>Notion Page</p>
        </Link>
        <Link
          href={`/onboarding?type=document`}
          className="flex min-h-[200px] flex-col items-center justify-center space-y-5 overflow-hidden p-5 transition-colors hover:bg-gray-200 hover:dark:bg-gray-800 md:p-10"
        >
